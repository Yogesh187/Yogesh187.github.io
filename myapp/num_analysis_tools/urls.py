...
from .views import PhoneNumberAnalysisAPIView ,IMEILookupAPIView ,IMSIAnalysisAPIView,ICCIDAnalysisAPIView ,CreateIMEIRecordAPIView,ManualMCCMNCEntryAPIView
...
urlpatterns = [
    ...
    path('create-iccid/',ManualMCCMNCEntryAPIView.as_view(),name='create-iccid')
]